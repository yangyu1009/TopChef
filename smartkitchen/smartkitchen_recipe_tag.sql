...
CREATE TABLE `recipe_tag` (
  ...
  KEY `t_id` (`t_id`),
  CONSTRAINT `recipe_tag_ibfk_1` FOREIGN KEY (`r_id`) REFERENCES `recipe` (`r_id`) ON DELETE CASCADE,
  CONSTRAINT `recipe_tag_ibfk_2` FOREIGN KEY (`t_id`) REFERENCES `tag` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2019-11-25 22:13:16
